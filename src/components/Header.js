  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/gmeadiv" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div className="row aligner" style={{height: '100%', zIndex: 1}}>
